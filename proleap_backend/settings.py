"""
Django settings for proleap_backend project.
...
# NOTE: export DJANGO_SETTINGS_MODULE=proleap_backend.settings_production 
...
WSGI_APPLICATION = 'proleap_backend.wsgi.application'
