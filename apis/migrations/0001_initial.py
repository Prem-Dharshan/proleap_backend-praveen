    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SHORT_ANSWER', 'short_answer'), ('PARAGRAPH', 'paragraph'), ('NUMBER', 'number'), ('RADIO', 'radio'), ('DATE', 'date'), ('FILE', 'file'), ('CHECKBOXES', 'checkboxes'), ('URL', 'url'), ('IMAGE', 'image'), ('TIME', 'time'), ('EMAIL', 'email')], default='SHORT_ANSWER', max_length=64)),
                ('desc', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.AddConstraint(
            model_name='answer',
            constraint=models.UniqueConstraint(fields=('user', 'question', 'option', 'answer'), name='unique_user_question_option_answer'),
        ),
        migrations.AddConstraint(
